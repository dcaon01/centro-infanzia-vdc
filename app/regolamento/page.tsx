...
const RegulationPage = () => {
    ...
    function handleDocumentDownload(): void {
        window.open("/documents/regulations/regolamento-centro-infanzia-APRILE-2026.pdf", "_blank", "noopener,noreferrer");
    }
            ...
            <div className={classes.pageContent}>
                <div className={classes.previewContainer}>
                    <motion.img
                        ...
                        src="/images/documents-previews/regolamento-centro-infanzia-APRILE-2026.png"
